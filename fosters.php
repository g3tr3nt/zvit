...
<div class="page">
    ...
    <main  class="main">
        <div class="bshop">
            <img src="b5.png" class="b2">
        </div>
        <div class="bshoptext">
            <p class="neonText"><i class="name">Foster's</i> </p>
            <p class="neonText"><i class="cost">2.49$-28.4$</i></p>
            <button type="submit" class="buy4">Buy now</button>
            <p class="neonText"><i class="stext4">Foster's Lager is an internationally-distributed brand of lager.
                    It is brewed in several countries including Australia, the UK, and the US. The beer has a 5% alcohol content and is sold in a blue and gold can or bottle.

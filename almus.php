...
<div class="page">
    ...
    <main  class="main">
        <div class="bshop">
            <img src="b8.png" class="b2">
        </div>
        <div class="bshoptext">
            <p class="neonText"><i class="name">Almus</i> </p>
            <p class="neonText"><i class="cost">3.3$-19.8$</i></p>
            <button type="submit" class="buy6">Buy now</button>
            <p class="neonText"><i class="stext6">Almus beer is a Bulgarian beer brand that produces American Adjunct Lager style beer.
                    The beer is brewed by Lomsko Pivo in Lom, Bulgaria. Almus Lux Beer is one of their popular beers.

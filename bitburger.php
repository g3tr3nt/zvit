...
<div class="page">
    ...
    <main  class="main">
        <div class="bshop">
            <img src="b3.png" class="b2">
        </div>
        <div class="bshoptext">
            <p class="neonText"><i class="name">Bitburger</i> </p>
            <p class="neonText"><i class="cost">1.5$-25.3$</i></p>
            <button type="submit" class="buy3">Buy now</button>
            <p class="neonText"><i class="stext">Bitburger is a German brewery founded in 1817 by Johann Wallenborn.
                    The company produces several beers including Bitburger Premium Pils, Bitburger Drive, and Bitburger Radler.
            </p>
        </div>
    </main>
